        ...
        <div className="h-[150px] w-full bg-[url(img/bottom-banner1.jpg)] bg-cover text-gray-400">
            ...
            <div className="w-[90%] h-full mx-4 mb-5 flex justify-between items-center">
                ...
                <div className="flex items-center">
                    <input type="search" placeholder="Search for product" className="bg-white py-3 px-18 border-r border-gray-400 rounded-md rounded-r-none" />
                    <span class="material-symbols-outlined p-3 bg-white rounded-md rounded-l-none">
                     search
                </span>
                </div>
                {/* search ended */}
                {/* like start */}
                <div className="flex items-center">
                    <button className="border border-gray-500 p-2 rounded-md rounded-r-none">
                        <span class="material-symbols-outlined  hover:cursor-pointer hover:text-green-500">
android_cell_5_bar
</span>
                    </button>
                    <button className="border border-l-0 border-gray-500 p-2 rounded-md rounded-l-none">
                        <span class="material-symbols-outlined  hover:cursor-pointer hover:text-green-500">
favorite
</span>
                    </button>
                ...
                {/* add to cart start */}
                <div className="flex items-center">
                    <button className="p-[11px] border-r border-gray-400 bg-white rounded-md rounded-r-none">
                        <span class="material-symbols-outlined">
shopping_cart
</span>
                    </button>
                    <button className="py-3.5 px-12 border-r font-bold border-gray-400 bg-white rounded-md rounded-l-none">
